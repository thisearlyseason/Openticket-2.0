...
import { Plus, Ticket, User, LayoutDashboard, Settings as SettingsIcon, Home as HomeIcon, Search, Sun, Moon, LogOut, ExternalLink, AlertTriangle, Loader2, WifiOff, Info, Gift, Briefcase, UserCircle, Menu } from 'lucide-react';
