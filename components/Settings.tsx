...
import { User as UserIcon, Settings as SettingsIcon, LogOut, Camera, Bell, ChevronRight, Palette, CreditCard, Shield, Mail, CheckCircle, XCircle, Plus, Trash2, LayoutTemplate, Globe, Instagram, Facebook, Twitter, Youtube, Gift, DollarSign, AlertCircle, Eye, Send, Briefcase, Smartphone, Monitor } from 'lucide-react';
...
export const Settings = () => {
    ...
    useEffect(() => {
        const loadUserData = async () => {
            ...
            if (currentUser) {
                ...
                setEmailProvider(currentUser.emailProvider || 'resend');
    ...
    return (
        <div className="max-w-5xl mx-auto py-12 px-4 pb-24">
            {/* Profile Completion Tracker for Organizers */}
            {user?.role === 'organizer' && profileCompleteness.percentage < 100 && (
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-3">
                                Complete your profile to unlock all features and build trust with attendees.
                            </p>
                            ...
                            {/* Missing Fields */}
                            {profileCompleteness.emptyFields.length > 0 && (
                                <div className="text-xs text-zinc-500 dark:text-zinc-400 mb-3">
                                    <strong>Missing:</strong> {profileCompleteness.emptyFields.join(', ')}
                                </div>
                            )}
