...
import { Calendar, MapPin, Share2, Globe, Facebook, Instagram, Twitter, Youtube, Smartphone, Image as ImageIcon } from 'lucide-react';
...
export const OrganizerProfile = () => {
    ...
    const organizerName = organizer?.useBusinessName ? (organizer.businessName || organizer.name) : (organizer?.name || 'Organizer');
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-gray-400 max-w-lg mb-6">
                            {organizer?.organizerSubtitle || organizer?.businessType || 'Event Organizer'} • {events.length} Active Events
                        </p>
