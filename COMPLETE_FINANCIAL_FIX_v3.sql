-- =====================================================
-- COMPLETE FINANCIAL SYSTEM FIX v3 - RUN THIS IN SUPABASE SQL EDITOR
-- =====================================================
-- Fixes function already exists error
-- =====================================================
...
-- 6. CREATE FUNCTIONS
-- =====================================================
CREATE FUNCTION increment_registered_count(p_event_id TEXT, p_count INTEGER)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
CREATE FUNCTION process_checkout_success_v2(
    p_session_id TEXT,
