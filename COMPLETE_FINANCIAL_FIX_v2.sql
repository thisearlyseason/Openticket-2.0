-- =====================================================
-- COMPLETE FINANCIAL SYSTEM FIX v2 - RUN THIS IN SUPABASE SQL EDITOR
-- =====================================================
-- Fixes the "column action does not exist" error
-- =====================================================
...
-- =====================================================
-- 3. CREATE OR FIX FINANCIAL TRANSACTIONS TABLE
-- =====================================================
...
-- Add missing columns to financial_transactions if table already exists
...
-- =====================================================
-- 4. DROP AND RECREATE AUDIT LOGS TABLE (clean slate)
-- =====================================================
...
GRANT ALL ON financial_transactions TO anon;
...
GRANT EXECUTE ON FUNCTION increment_registered_count TO anon;
...
GRANT EXECUTE ON FUNCTION process_checkout_success_v2 TO anon;
