...
const normalizeEvent = (raw: any): Event => {
    ...
    return {
        ...
        taxRate: raw.tax_rate !== undefined ? Number(raw.tax_rate) : (raw.taxRate !== undefined ? Number(raw.taxRate) : 0),
...
export const StorageService = {
    ...
    saveEvent: async (event: Event): Promise<Event> => {
        ...
        // Map to snake_case - include ALL event fields
        const payload = {
            id: clean.id,
            title: clean.title,
            ...
            is_recurring: clean.isRecurring,
            recurring_dates: clean.recurringDates,
            time_format: clean.timeFormat,
            timeline: clean.timeline,
            location: clean.location,
            venue_name: clean.venueName,
            online_url: clean.onlineUrl,
            image_url: clean.imageUrl,
            cover_image_position: clean.coverImagePosition,
            gallery: clean.gallery,
            price: clean.price,
            price_type: clean.priceType,
            ticket_name: clean.ticketName,
            ...
            requires_approval: clean.requiresApproval,
            confirmation_message: clean.confirmationMessage,
            refund_policy: clean.refundPolicy,
            waiver_config: clean.waiverConfig,
            schedule_config: clean.scheduleConfig,
            tags: clean.tags,
            tracking_pixels: clean.trackingPixels,
            remarketing: clean.remarketing,
            seo: clean.seo,
            ...
            organizer_email: clean.organizerEmail,
            organizer_phone: clean.organizerPhone,
            organizer_website: clean.organizerWebsite,
